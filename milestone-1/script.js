// Helper function to validate if an input field is empty
...
function validateForm() {
    ...
    var isValid = true;
    // Check each field and apply error styles if necessary
...
function previewImage(event) {
    ...
    if (input.files && input.files[0]) {
        ...
        reader.onload = function (e) {
            var _a;
            profileDisplay.src = (_a = e.target) === null || _a === void 0 ? void 0 : _a.result;
        };
...
function generateResume() {
    ...
    // Show resume section and hide form
